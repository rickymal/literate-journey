import s from "./_modules_css/projectDescription.module.css";
    ...
    <div className={s.third_dashboard}>
      ...
      <div className={s.video_container}>
        ...
        <text>
          ...
          ultrices augue non laoreet dignissim. Morbi id sagittis tortor, a
          posuere sapien. Nam ornare tortor quis eros cursus bibendum. Lorem
          ipsum dolor sit amet, consectetur adipiscing elit. Nam fringilla vitae
          lacus nec egestas. Vestibulum malesuada id metus sed pharetra. Fusce
          at felis varius, fermentum lorem in, tristique lorem. Quisque ut
          ullamcorper ipsum. Proin eu vestibulum est. Pellentesque blandit purus
          elit, malesuada consequat odio condimentum in. Mauris justo nisi,
          aliquam vel scelerisque eget, ultricies ut ipsum.
        </text>
      </div>
      {/* */}
      ...
      <div className={s.description}>
        ...
        <text className={s.text_h3_description}>
          Comentário sobre o projeto
        </text>
        <input
          className={s.input_style_nameproject}
          type="text"
          style={{
            minWidth: "60%",
            minHeight: "100px",
