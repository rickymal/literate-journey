...
export default function Registration() {
    ...
    <div className = {s.container}> 
        ...
        />
            ...
            <Info placeholder = "Email ou LinkedIn" name = "Você foi indicado por alguém?"/>
            <Info placeholder = "" name = "Qual sua área de atuação?"/>
            <Info placeholder = "Universidade" name = "Você estuda? Onde?"/>
            <Info placeholder = "" name = "Qual curso?"/>
